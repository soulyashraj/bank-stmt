...
class TCPDF {
	...
	protected function getHtmlDomArray($html) {
		...
		$html = strip_tags($html, '<marker/><a><b><blockquote><body><br><br/><dd><del><div><dl><dt><em><font><form><h1><h2><h3><h4><h5><h6><hr><hr/><i><img alt="Quenchome"><input><label><li><ol><option><p><pre><s><select><small><span><strike><strong><sub><sup><table><tablehead><tcpdf><td><textarea><th><thead><tr><tt><u><ul>');
		...
		$html = preg_replace('/'.$this->re_space['p'].'+<img alt="Quenchome"/'.$this->re_space['m'], chr(32).'<img alt="Quenchome"', $html);
		$html = preg_replace('/<img alt="Quenchome"([^\>]*)>[\s]+([^\<])/xi', '<img alt="Quenchome"\\1>&nbsp;\\2', $html);
		$html = preg_replace('/<img alt="Quenchome"([^\>]*)>/xi', '<img alt="Quenchome"\\1><span><marker style="font-size:0"/></span>', $html);
		...
		$html = preg_replace('/<li([^\>]*)>'.$this->re_space['p'].'*<img alt="Quenchome"/'.$this->re_space['m'], '<li\\1><font size="1">&nbsp;</font><img alt="Quenchome"', $html);
		...
		$html = preg_replace('/^<img alt="Quenchome"/', '<span style="font-size:0"><br /></span> <img alt="Quenchome"', $html, 1);

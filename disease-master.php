<?php
    ...
    $pageName    = "Disease Master";
    
    $pageURL     = 'disease-master.php';
    
    $deleteURL   = 'disease-master.php';
    ...
    $results     = $admin->query("SELECT * FROM hp_disease_master WHERE deleted_time = 0 ORDER BY id DESC");
   ...
   if(isset($_GET['delId']) && !empty($_GET['delId'])){
    ...
    if(isset($_POST['register'])){
        ...
        if($csrf->check_valid('post')) {
            ...
            $result = $admin->addDiseaseMaster($_POST,$loggedInUserDetailsArr['id'],'disease_master');
    ...
    if(isset($_GET['edit'])){
        ...
        $data          = $admin->getUniqueDiseaseMaster($id,'disease_master');
    ...
    if(isset($_POST['id']) && !empty($_POST['id'])) {
        ...
        if($csrf->check_valid('post')) {
            ...
            $result = $admin->updateDiseaseMaster($_POST, $loggedInUserDetailsArr['id'],'disease_master');
                        ...
                        <div id="cardeffect" style="display:none;">
                            ...
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3 fromerrorcheck">
                                            ...
                                            <label>Disease Name<em>*</em> </label>
                                            
                                            <input type="text" name="disease_name" id="diseaseName" value="<?php if(isset($_GET['edit'])) { echo $data['disease_name']; } ?>" class="form-control form-control-sm rounded-0">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary" id="uploadBill" onclick="uploadBulkExcelFile()"><i class="fas fa-upload"></i> Upload Disease Excel </a>
...
<script>
    ...
    if (valid) {
	    ...
	    formData.append('database_name', 'disease_master');
